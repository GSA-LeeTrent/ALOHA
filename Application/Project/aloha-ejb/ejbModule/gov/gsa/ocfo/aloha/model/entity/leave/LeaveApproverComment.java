...
/**
 * The persistent class for the LR_APPROVER_COMMENT database table.
 * 
 */
@Entity
@Table(name="LR_APPROVER_COMMENT", schema="ALOHA")
public class LeaveApproverComment implements Serializable {
    ...
    ********************************************************************************************/	
	...
	private static final long serialVersionUID = -4243613898765368835L;

	@Id
	@SequenceGenerator(name="LR_APPROVER_COMMENT_ID_GENERATOR", sequenceName="ALOHA.SEQ_LR_APPROVER_COMMENT", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="LR_APPROVER_COMMENT_ID_GENERATOR")
	@Column(name="LR_APPROVER_COMMENT_ID", unique=true, nullable=false, precision=10)
	private long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LeaveApproverComment other = (LeaveApproverComment) obj;
		if (id != other.id)
			return false;
