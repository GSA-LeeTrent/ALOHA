...
@FacesValidator("gov.gsa.ocfo.aloha.web.validator.ApproverValidator")
public class ApproverValidator implements Validator {
	@Override
	public void validate(FacesContext context, UIComponent compoenent, Object obj)
			throws ValidatorException {
		
			String selectedApprover = obj.toString();
			if ( Integer.parseInt(selectedApprover) < 1) {
