...
@ManagedBean(name=OTMgrListTabSetIndivMB.MANAGED_BEAN_NAME)
@SessionScoped
public class OTMgrListTabSetIndivMB implements TabChangeListener, Serializable {
	private static final long serialVersionUID = 3353907812254207529L;

	public static final String MANAGED_BEAN_NAME = "otMgrListTabSetIndivMB";
